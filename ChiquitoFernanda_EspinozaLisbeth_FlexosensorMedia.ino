#define tam_sig 70 //tamaño de la señal
...
void loop() {
  mean ((double *)&flex_sensor[0], (double *)&output_signal[0], (int) tam_sig,9);
  sruido();
  plot_signal();
  delay(100);
...
void sruido(){
  ...
  for(int i=0;i<tam_sig;i++){
    ...
    ru2[i]=pow((flex_sensor[i]-output_signal[i]),2);
